  ...
  return (
    <div>
      ...
      <div className="landing-stats-container">
        ...
        <LandingStats img="" number="30" subheader="Majors Represented">
          {" "}
        </LandingStats>
        <LandingStats img="" number="5" subheader="Years of Work Carried Out">
          {" "}
        </LandingStats>
        <LandingStats img="" number="30" subheader="Active Members">
          {" "}
        </LandingStats>
      </div>
      ...
      <div className="landing-projSummary-container">
        <LandingProjSummary
          ...
          proj="Project name"
          pillar="Health"
          text="This project is lit Yall"
          view="put hyperlink here"
        >
          {" "}
        </LandingProjSummary>
        <LandingProjSummary
      ...
      <div className="landing-collab-container">
        <LandingCollab
          title="Clients"
          text="Please work with us bro"
          button1="Learn More"
          button2="Past Work"
        ></LandingCollab>
        <LandingCollab
          title="Students"
          text="Please join our club :)"
          button1="Club Culture"
          button2="Recruitment"
        ></LandingCollab>
      </div>
